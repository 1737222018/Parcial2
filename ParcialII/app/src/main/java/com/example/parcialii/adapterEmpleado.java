...
public class adapterEmpleado extends ArrayAdapter<empleadoclass> {
    private Context context;
    private int layoutResourceId;
    private ArrayList<empleadoclass> data = null;

    public adapterEmpleado(Context context, int layoutResourceId, ArrayList<empleadoclass> data) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        empleadoclass empleado = data.get(position);
